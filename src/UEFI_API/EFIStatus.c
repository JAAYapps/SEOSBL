...
char *CheckStandardEFIError(unsigned long long s)
{
    switch (s)
    {
    case EFI_LOAD_ERROR:
    ...
    {
        return " WARNING - Unknown Glyph\r\n";
    }
    case EFI_WARN_DELETE_FAILURE:
    {
        return " WARNING - Delete Failure\r\n";
    }
    case EFI_WARN_WRITE_FAILURE:
    {
        return " WARNING - Write Failure\r\n";
    }
    case EFI_WARN_BUFFER_TOO_SMALL:
    {
        return " WARNING - Buffer Too Small\r\n";
    }
    case EFI_WARN_STALE_DATA:
    {
        return " WARNING - Stale Data\r\n";
    }
    case EFI_WARN_FILE_SYSTEM:
    {
        return " WARNING - File System\r\n";
    }
    case EFI_WARN_RESET_REQUIRED:
    {
        return " WARNING - Reset Required\r\n";
    }
    case EFI_SUCCESS:
    {
        return " Successful\r\n";
...
// CHAR16 variant of the CheckStandardEFIError function
unsigned short int *CHAR16OfCheckStandardEFIError(unsigned long long s)
{
    switch (s)
    {
    case EFI_LOAD_ERROR:
